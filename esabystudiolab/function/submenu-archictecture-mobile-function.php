<?php
add_action( 'wp_ajax_submenu_archictecture_mobile', 'submenu_archictecture_mobile' );
add_action( 'wp_ajax_nopriv_submenu_archictecture_mobile', 'submenu_archictecture_mobile' );

function submenu_archictecture_mobile(){
    ...
    foreach($familles as $famille){
        ...
        $htmlLevelOne .= '" onmousedown="clickArchitectureMobile(this)" data-level="one" data-id="' ;
        $htmlLevelOne .= $famille->slug; 
        $htmlLevelOne .= '" data-action="submenu_archictecture_mobile" data-nonce="';
        $htmlLevelOne .= wp_create_nonce('submenu_archictecture_mobile');
