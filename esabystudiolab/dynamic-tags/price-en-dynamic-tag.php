<?php 
class Elementor_Product_Price_En_Tag extends \Elementor\Core\DynamicTags\Tag {

public function get_name() {
    return 'product-price-en';
}

public function get_title() {
    return __( 'Product price', 'elementor' );
}
...
public function render() {
    ...
    if ( $product->is_type( 'variable' ) ) {
        ...
        if ($product->get_price() == 0){
            ...
            echo 'from ' , wc_price($product->get_price());
        }
