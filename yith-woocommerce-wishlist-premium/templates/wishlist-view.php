...
<table
	...
	<tr>
		...
		<th class="product-name">
			<br>
			<span class="nobr">Collection</span>
		</th>
		...
		<th class="product-name">
			<br>
			<span class="nobr">Dimension</span>
		</th>
		...
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				...
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					...
					<?php $meta =  $product->get_meta_data(); ?>
					

					<td><?php 
					$dimensionfr = get_post_meta($product->get_id(), 'dimension-cm', true);
					if (!empty($dimensionfr)) {
						echo $dimensionfr;
					}
					?> <br>
					<?php 
					$dimensionen = get_post_meta($product->get_id(), 'dimension-inch', true);
